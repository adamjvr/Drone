...
| encounter actor integration | CURRENT | all 17 trajectory groups, exact live transient formation timing/template/path randomization, and shareware-reachable Lid/Top/Gemini lifecycle/score tails are session-owned; exact sprite-mask collision producers, boss movement/attacks and remaining non-trajectory enemies remain to be connected |
