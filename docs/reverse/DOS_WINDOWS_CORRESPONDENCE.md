...
| common sprite/entity object | repeated `0x14F`-byte DOS family | `0x154`-byte Win32 family initialized at `0x00401780` | strong structural correspondence candidate; layouts are not assumed identical |
